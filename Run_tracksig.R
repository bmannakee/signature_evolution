...
test_file <- fs::fs_path('~/Desktop/projects/signature_evolution/PD11461_relapse.bed')
...
fr <- run_tracksig(test_file,BSgenome.Hsapiens.UCSC.hg38,bin_size=100,file_type="bed")
